...
- 	En fin de programme, une MsgBox informe l'utilisateur de la fin du traitement (l'application reste ouverte ainsi que le fichier source)<br>
<br>
<br>
